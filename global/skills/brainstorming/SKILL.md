...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md`. This is a local working artifact (globally gitignored) — do NOT `git add`/commit it.
...
- Do NOT commit the design document. It is a local working artifact and is
  globally gitignored (`docs/superpowers/specs/`). Leave it untracked.
