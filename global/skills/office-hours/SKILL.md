...
## Related skills
- [[spec]] — once the idea survives office hours, write a precise spec before implementation
- [[product-plan-review]] — if a plan already exists, review it through a product/founder lens
- Matching subagent: **founder-reviewer**
